import {
    PLAYER_SPEED, CHARGE_MAX_TIME, INITIAL_SNOWBALL_RADIUS, MAX_SNOWBALL_RADIUS,
    CHARGE_OFFSET_DISTANCE, SNOWBALL_SPEED, MAX_SNOWBALL_SPEED,
    INITIAL_SNOWBALL_DAMAGE, MAX_SNOWBALL_DAMAGE, FIXED_VIEW_WIDTH, FIXED_VIEW_HEIGHT
} from "../core/constants.js";
import { createPlayer } from "../entities/player.js";
import { createSnowball } from "../entities/snowball.js";
import { checkAlive } from "../systems/updater.js";
import { updateMovement, updateChargingIndicator } from "../systems/input.js";
import { handleServerMessage } from "../systems/network.js";

export class GameScene extends Phaser.Scene {
    constructor() {
        super({ key: "GameScene" });
        this.serverTimeOffset = 0; // Time offset for synchronization
    }
    ...
    update() {
        ...
        updateMovement(this, this.cursors, this.keyA, this.keyD, this.keyW, this.keyS, this.player);
